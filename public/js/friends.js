...
function _elmoreFetch() {
  _elmoreFetch = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee($url, $data) {
    ...
    value: function initializeNotifications() {
      ...
      try {
        var _loop = function _loop() {
          ...
          container.querySelector(".friendship-accept").addEventListener("click", function () {
